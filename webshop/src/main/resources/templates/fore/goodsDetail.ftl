    ...
    <div class="container">
        <div class="single-grids">
            ...
            <div class="col-md-4 single-grid simpleCart_shelfItem">
                ...
                <div class="tag">
                    <p>分类 :
                        <a href="goods.action?typeid=5">经典系列</a></p>
                </div>
                <p>${goodsDetail.goods.intro}</p>
                <div class="galry">
                    <div class="prices">
                        <h5 class="item_price">¥ ${goodsDetail.goods.price}</h5></div>
                    <div class="clearfix"></div>
                </div>
                <div class="btn_form">
                    <a href="javascript:;" class="add-cart item_add" onclick="buy(6)">加入购物车</a></div>
            </div>
            <div class="col-md-4 single-grid1">
                ...
                <ul>
                  ...
                  <#list typesList as list>
                    <li>
                        <a href="/fore/goodsList?id=${list.id}&pageNo=1">${list.name}</a></li>
				  </#list>
                </ul>
            </div>
            <div class="clearfix"></div>
